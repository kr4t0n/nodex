...
async function cmdNewLanguage(slug: string, explicit?: string): Promise<void> {
  ...
  const files = await planFiles(root, [
    ...
    { relative: `${base}/DESIGN.md`, content: `# ${title}\n\n## Visual atmosphere\n\nDescribe density, geometry and intended reading.\n\n## Color and typography\n\nExplain the semantic token roles, type scale and contrast requirements.\n\n## Component behavior\n\nComponents are editable React modules with typed data props. Charts use Recharts by default.\n\n## Tokens\n\nReference generated --nx-* CSS variables for presentation. Resolve numeric tokens only when a library needs numbers.\n\n## Motion\n\nHonor prefers-reduced-motion and use the language motion tokens.\n\n## Authoring\n\nEach item declares entry, exports, files, dependencies, preview and optional props in meta.json. Keep sample data in example.tsx.\n\n## Anti-patterns\n\nRecord the specific geometry, paint and interaction choices this language forbids.\n` },
  ]);
